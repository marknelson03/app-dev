...
export default function RegisterPage() {
  ...
  return (
    <div className="px-4 py-8 w-full max-w-[500px] mx-auto bg-white/40 backdrop-blur-md shadow-md rounded-2xl">
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
        ...
        <div className="flex flex-col items-center space-y-4">
          ...
          <a href="/login" className="text-blue-600 hover:underline text-center">
